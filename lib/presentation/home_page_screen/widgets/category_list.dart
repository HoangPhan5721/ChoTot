...
import 'package:intern/presentation/home_page_screen/widgets/category_detail_screen.dart';
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          ...
          CategoryItem(name: 'Đồ gia dụng, nội thất', icon: FontAwesomeIcons.kitchenSet),
